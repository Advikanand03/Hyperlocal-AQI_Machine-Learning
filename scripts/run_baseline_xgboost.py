...
try:
    ...
    raise ImportError("xgboost must be installed to run this script") from e
...
def main():
    ...
    out_path = root / "outputs" / "baseline_xgboost.csv"
    out_path.parent.mkdir(parents=True, exist_ok=True)
    results_df.to_csv(out_path, index=False)

    print("✅ XGBoost baseline completed ->", out_path)
